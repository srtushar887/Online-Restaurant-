                ...
                <ul class="metismenu list-unstyled" id="side-menu">
                    ...
                    <li>
                        <a href="{{route('admin.general.settings')}}" class="waves-effect">
                            <i class="bx bx-chat"></i>
                            <span key="t-chat">General Setting</span>
                        </a>
                    </li>
                    <li>
                        <a href="{{route('admin.store.type')}}" class="waves-effect">
                            <i class="bx bx-chat"></i>
                            <span key="t-chat">Store Type</span>
                        </a>
                    </li>
                    ...
                    <li>
                        <a href="{{route('admin.measurement')}}" class="waves-effect">
                            <i class="bx bx-chat"></i>
                            <span key="t-chat">Measurement</span>
                        </a>
                    </li>
                    ...
                    <li>
                        <a href="{{route('admin.store.items')}}" class="waves-effect">
                            <i class="bx bx-chat"></i>
                            <span key="t-chat">Store Items</span>
                        </a>
                    </li>
                    ...
                    <li>
                        <a href="chat.html" class="waves-effect">
                            <i class="bx bx-chat"></i>
                            <span key="t-chat">Coupon Code</span>
                        </a>
                    </li>
                    ...
                    <li>
                        <a href="chat.html" class="waves-effect">
                            <i class="bx bx-chat"></i>
                            <span key="t-chat">Users Coupon Code</span>
                        </a>
                    </li>
                    <li>
                        <a href="chat.html" class="waves-effect">
                            <i class="bx bx-chat"></i>
                            <span key="t-chat">Delivery Fees</span>
                        </a>
                    </li>
                    ...
                    <li>
                        <a href="javascript: void(0);" class="has-arrow waves-effect">
                            <i class="bx bx-store"></i>
                            <span key="t-ecommerce">Delivery Boy</span>
                        </a>
                        <ul class="sub-menu" aria-expanded="false">
                            <li><a href="{{route('admin.delete.boy.create')}}" key="t-products">Create Delivery Boy</a>
                            </li>
                            <li><a href="{{route('admin.delete.boy.list')}}" key="t-product-detail">Manage Delivery
                                    Boy</a>
                            </li>
                            <li><a href="{{route('admin.assign.delivery.boy')}}" key="t-product-detail">Assign Delivery
                                    Boy</a>
                            </li>
                        </ul>
                    </li>
                    ...
                    <li>
                        <a href="javascript: void(0);" class="has-arrow waves-effect">
                            <i class="bx bx-store"></i>
                            <span key="t-ecommerce">Mobile Part</span>
                        </a>
                        <ul class="sub-menu" aria-expanded="false">
                            <li><a href="ecommerce-products.html" key="t-products">Promotion Video</a></li>
                            <li><a href="ecommerce-product-detail.html" key="t-product-detail">Promotion Image</a></li>
                        </ul>
                    </li>
