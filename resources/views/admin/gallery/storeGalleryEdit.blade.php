...
@section('admin')
    ...
    <div class="row">
        <div class="col-xl-12">
            <div class="card">
                <div class="card-body">
                    <form class="needs-validation" novalidate="" action="{{route('admin.store.gallery.update')}}"
                          method="post"
                        ...
                        <div class="row">
                                ...
                                <div class="mb-3">
                                    ...
                                    <select class="form-control" name="restaurant_id">
                                        ...
                                        @foreach($all_res as $res)
                                            <option
                                                value="{{$res->id}}" {{$gallery->restaurant_id == $res->id ? 'selected' : ''}}>{{$res->restaurant_name}}</option>
                                        @endforeach
                                    </select>
                                    <input type="hidden" name="gallery_edit" value="{{$gallery->id}}">
                                </div>
                            </div>
                            <div class="col-md-12">
                                <div class="mb-3">
                            ...
                            <div class="col-md-4">
                                <div class="mb-3">
                                    ...
                                    <br>
                                    <img src="{{asset($gallery->main_image)}}" style="height: 100px;width: 100px;">
                            ...
                            <div class="col-md-4">
                                <div class="mb-3">
                                    ...
                                    <br>
                                    <img src="{{asset($gallery->optional_image_one)}}"
                            ...
                            <div class="col-md-4">
                                <div class="mb-3">
                                    <label for="validationCustom01" class="form-label">Optional Image</label>
                                    <br>
                                    <img src="{{asset($gallery->optional_image_two)}}"
                                         style="height: 100px;width: 100px;">
                            ...
                            <div class="col-md-4">
                                <div class="mb-3">
                                    <label for="validationCustom01" class="form-label">Optional Image</label>
                                    <br>
                                    <img src="{{asset($gallery->optional_image_three)}}"
                                         style="height: 100px;width: 100px;">
                            ...
                            <div class="col-md-4">
                                <div class="mb-3">
                                    <label for="validationCustom01" class="form-label">Optional Image</label>
                                    <br>
                                    <img src="{{asset($gallery->optional_image_four)}}"
                                         style="height: 100px;width: 100px;">
                            ...
                            <div class="col-md-4">
                                <div class="mb-3">
                                    <label for="validationCustom01" class="form-label">Optional Image</label>
                                    <br>
                                    <img src="{{asset($gallery->optional_image_five)}}"
                                         style="height: 100px;width: 100px;">
